...
public class RobotState {
    ...
    public void addOdometryObservation(OdometryObservation observation) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            Logger.recordOutput("RobotState/module" + Integer.toString(i) + "/linearDisplacement", moduleDisplacement);
        ...
        Logger.recordOutput("RobotState/totalDisplacement", robotDisplacement);
        robotDisplacement = robotDisplacement.div(4);
        Logger.recordOutput("RobotState/averagedDisplacement", robotDisplacement);
        robotDisplacement = robotDisplacement.rotateBy(lastObservation.gyroAngle.get());
        Logger.recordOutput("RobotState/fieldRelativeDisplacement", robotDisplacement);

        odometryPose = new Pose2d(odometryPose.plus(new Transform2d(robotDisplacement, Rotation2d.kZero))
